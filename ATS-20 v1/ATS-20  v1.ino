/*
  ...
  *4 - Some encoder devices have pins A and B inverted. So, if the clockwise and counterclockwise directions 
  ...
  thanks to Ricardo PU2CLR and Darren VE3XLT
...
Band band[] = {
  ...
  {SW_BAND_TYPE, 3500, 3800, 3700, 0, 5, "80M"},     // 80 meters HAM
  {SW_BAND_TYPE, 3800, 4700, 3700, 1, 4},
  {SW_BAND_TYPE, 4700, 5100, 4500, 1, 4, "60SW"},     // 60 meters  BC
  {SW_BAND_TYPE, 5100, 5800, 5400, 0, 4, "60M"},     // 60 metres HAM
  {SW_BAND_TYPE, 5800, 6300, 6000, 1, 4, "49SW"},     // 49 meters BC 
  {SW_BAND_TYPE, 6300, 7000, 6800, 0, 4, "AIRHF"},     //HF airband, VOLMETS
  ...
  {SW_BAND_TYPE, 18800, 19100, 18600, 1, 4, "15SW"},  // 15 meters BC
  {SW_BAND_TYPE, 19100, 21000, 20000, 1, 4},  
  {SW_BAND_TYPE, 21000, 21450, 21200, 0, 4, "15M"},  // 15 mters HAM
  {SW_BAND_TYPE, 21450, 22000, 21500, 1, 4, "13SW"},  // 13 mters BC
  {SW_BAND_TYPE, 22000, 24890, 23000, 1, 4},
  {SW_BAND_TYPE, 24890, 25000, 24940, 0, 4, "12M"},  // 12 meters HAM
  {SW_BAND_TYPE, 25000, 26205, 25800, 1, 4, "11SW"},  // 11 meters BC
  {SW_BAND_TYPE, 26205, 28000, 27065, 3, 4, "CB"},  // CB band (11 meters)
